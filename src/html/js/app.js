			...
			if (text.length > 0) {
				...
				if( $.inArray(text, brunches) == -1) {
					...
					$(".branchesRadios").append('<div class="radio">'+
												'	<label>'+
												'		<input type="radio" name="currentBranch" value="'+ text +'">'+ text +
												'	</label>'+
