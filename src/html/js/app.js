	...
	App = {
        ...
        addAllPackagesMissedTranslatesMenuItemClicked: function(event) {
			...
			if ($(".jsPackageName") && $(".jsPackageName").data("project-id")) {
				var id = $(".jsPackageName").data("project-id");
				active_package = self.getPackageByProjectId(id);
				this.displayPackage(id);
			}
        ...
        setInitialStatuses: function(packages) {
            var self = this;
			$.each(packages, function( p_index, p ) {
